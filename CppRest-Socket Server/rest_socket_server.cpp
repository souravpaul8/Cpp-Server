...
void *start_function(void *arg)
{
  ...
  bzero((char *)&serverAddress.sin_addr.s_addr, sizeof(serverAddress.sin_addr.s_addr));
  ...
  // while ((n = read(sockfd, buffer1, 256)) > 0)
  // {
  //   serverResponse.append(buffer1, n);
  // }
